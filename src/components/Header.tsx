...
export default function MenuAppBar({ onMenuClick }: Props) {
  ...
  React.useEffect(() => {
    ...
    // Only admin with kumar@gmail.com can be logged in
    if (authToken && userEmail === "kumar@gmail.com") {
  ...
  // Handle Book Appointment (for clients)
  const handleBookAppointment = () => {
    handleClose();
    navigate("/book-appointment"); // Clients can book without login
  };
            ...
            >
              ...
              {isAdminLoggedIn ? (
                <>
                  ...
                  {/* <MenuItem onClick={handleViewBookings}>
                    View All Bookings  */}
                  {/* </MenuItem> */}
